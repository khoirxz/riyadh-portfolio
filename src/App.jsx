  ...
  return (
    <div className="font-oswald text-zinc-900 dark:text-white antialiased bg-white dark:bg-zinc-900">
      ...
      <div className="flex flex-col gap-8 mt-8 max-w-screen-md mx-auto container">
        <div className="px-4 lg:px-0 gap-52 grid grid-cols-[150px_1fr]">
          <div>
          ...
          <div>
            <p className="font-figtree">
              ...
              quas ut hic ipsum porro maiores laudantium qui voluptas? Quibusdam
              quo fugiat tempore iure similique, doloremque illo eaque suscipit
              officia assumenda? Voluptatem eos aliquid quisquam necessitatibus
              cumque veniam quasi earum esse velit quae possimus repellendus
              fugiat error, suscipit perferendis doloremque, voluptatum odit
              asperiores sint impedit, minus quod.
            </p>
          </div>
        </div>

        <div className="px-4 lg:px-0 flex flex-col gap-3 font-figtree">
          <>
            {/* Timeline */}
            <div>
              {/* Heading */}
